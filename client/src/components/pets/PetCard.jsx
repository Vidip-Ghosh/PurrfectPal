...
const PetCard = (props) => {
  ...
  console.log(profile);
  return (
    <div className="py-[1.5rem] px-[1rem] md:px-[1rem] rounded-[3rem] bg-[#EEF3FF] border-t-2 border-l-2 border-[#0B0019] flex flex-col gap-[0.6rem] vsm:gap-[1rem] items-center shadow-custom w-[95%] md:w-[65%] mmd:w-[60%] lg:w-[60%]">
